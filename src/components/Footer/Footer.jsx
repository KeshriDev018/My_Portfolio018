  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-xl font-semibold text-purple-500">Ankit Keshri</h2>
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            {
              icon: <FaInstagram />,
              link: "https://www.instagram.com/ankit_keshri_52?igsh=MXNxdHUwbmNsZXEw",
            },
          ].map((item, index) => (
            <a
              key={index}
        ...
        <p className="text-sm text-gray-400 mt-6">
          © 2025 Ankit Keshri. All rights reserved.
        </p>
      </div>
    </footer>
  );
