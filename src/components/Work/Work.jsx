    ...
    >
            ...
            <div className="p-4">
              ...
              <div className="mb-2 flex flex-wrap">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-block bg-[#251f38] text-[10px] font-semibold text-purple-500 rounded-full px-2 py-0.5 mr-2 mb-2"
                  >
                    {tag}
                  </span>
                ))}
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-3xl overflow-y-auto max-h-[85vh] relative">
            {/* Close Button */}
            ...
            <div className="flex flex-col items-center px-6 pb-6">
              ...
              {/* Description */}
              <p className="text-gray-400 mb-5 text-base text-center">
